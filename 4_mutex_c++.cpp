...
// Mutex: Mutual Exclusion - Ensures only one process or thread can access a shared resource, or "critical section," at a time
...
int main() {
	...
	cout << myAmount << endl; // 1 (without mutex) | 2 (with mutex)
	return 0;
}
