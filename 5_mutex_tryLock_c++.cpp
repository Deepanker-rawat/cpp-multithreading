...
// 2. If try_lock is called again(double try_lock) by the same thread which owns the mutex, the behavior is undefined.
...
deepankerrawat@MacBookAir Multi_Threading % ./a.out
 counter could increases upto : 100004
deepankerrawat@MacBookAir Multi_Threading % ./a.out
 counter could increases upto : 81171
deepankerrawat@MacBookAir Multi_Threading % ./a.out
 counter could increases upto : 50054
deepankerrawat@MacBookAir Multi_Threading % ./a.out
 counter could increases upto : 95170
*/
