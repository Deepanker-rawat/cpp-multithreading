...
int main() {
    ...
    // Once we create a thread that thread is marked as joinable and then later once either you apply join()
    // or detach() on that thread then it automatically becomes non-joinable.
